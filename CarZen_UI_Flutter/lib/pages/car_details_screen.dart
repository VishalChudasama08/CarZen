...
class _SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
        ...
        builder: (context, _) => _card(context, SessionController.instance.isAdmin),
      );

  Widget _card(BuildContext context, bool isAdmin) {
    final car = listing.car;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (isAdmin)
            const Text(
              'You are signed in as an admin. Buying, saving cars and messaging sellers are done from user accounts.',
