...
class _AdminUserDetailScreenState extends State<AdminUserDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CarZenNavBar(current: NavSection.adminUsers, title: 'User details'),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _InfoRow(icon: Icons.toggle_on_outlined, label: 'Status', value: user.status),
              _InfoRow(
                icon: Icons.event_outlined,
                label: 'Member since',
                value: user.createdAt == null ? 'Unknown' : formatDateTime(user.createdAt as DateTime?),
              ),
              _InfoRow(
                icon: Icons.update_rounded,
                label: 'Last updated',
                value: user.updatedAt == null ? 'Never' : formatDateTime(user.updatedAt as DateTime?),
              ),
